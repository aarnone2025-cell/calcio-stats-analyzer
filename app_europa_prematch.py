...
if not player_options.empty:
    ...
    player_view = g[[
        "date", "season", "league", "match", "team", "opponent", "minutes",
...
st.divider()
st.caption(
    "Analisi esclusivamente pre-match. La probabilità usa al massimo le ultime 15 presenze valide, "
    "dà più peso alle gare recenti e applica una correzione verso la frequenza media del mercato "
    "nel campionato. Le percentuali sono stime statistiche, non garanzie di esito. "
