...
if enable_match_model and match_prediction_rows:
    ...
    if not coupon_df.empty:
        ...
        st.caption(
            "La probabilità combinata è una stima ottenuta moltiplicando le probabilità dei singoli eventi "
            "e assume indipendenza: va quindi letta come approssimazione, non come garanzia."
        )
    else:
        st.info(
            "Con i criteri scelti non ci sono abbastanza eventi adatti alla schedina. "
            "Prova 'Equilibrata' o riduci il numero di eventi."
        )
